  ...
  if (form.valid()) {
    ...
    if (msg1Object.status >= 200 && msg1Object.status <= 299) {
      ...
      document.getElementById("employees").innerHTML =
        msg1.results.total_employees;
      document.getElementById("description").innerHTML =
        msg1.results.sic_description;
    ...
    if (msg2Object.status >= 200 && msg2Object.status <= 299) {
      ...
      if (numdays > 0) {
        stockvaluetable =
          stockvaluetable +
          "<table><caption>Stock Price</caption><tr><th>Date</th><th>Price</th></tr>";
        for (var i = 0; i < numdays; i++) {
          stockvaluetable =
            stockvaluetable +
            "<tr><td>" +
      ...
      if (numdays > 0) {
        stockvolumetable =
          stockvolumetable +
          "<table><caption>Stock Volume</caption><tr><th>Date</th><th>Volume</th></tr>";
        for (var i = 0; i < numdays; i++) {
          stockvolumetable =
            stockvolumetable +
            "<tr><td>" +
